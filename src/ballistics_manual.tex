...
\centering
\vspace*{2cm}
{\Huge\bfseries Competition Rifle Ballistics\\[0.5cm]
...
In the absence of air resistance, the trajectory is a simple parabola:
\begin{align}
...
The equations of motion are solved numerically using a 4th-order Runge--Kutta (RK4) method \citep{press2007numerical}:
\begin{align}
...
The Didion approximation \citep{mccoy1999modern, litz2011applied}:
\begin{equation}
...
\begin{equation}
  \Delta y_{\mathrm{Eot}} \approx -\omega_E \cos\phi\sin\psi \cdot R \cdot t
  \label{eq:eotvos}
\end{equation}
...
Computing the cross product, the dominant terms for $v_x \gg v_y, v_z$:
\begin{align}
  a_z^{\mathrm{Cor}} &\approx 2\omega_E\,v_x\cos\phi \\
  a_y^{\mathrm{Cor}} &\approx -2\omega_E\,v_x\sin\phi
\end{align}
